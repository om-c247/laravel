...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- id, operator_id, vendore_id,ggr_value -->
...
<script>
    ...
    function validateForm() {
        ...
        if (title.trim() === '') {
            document.getElementById("error_title").innerText =  'Name is required.';
            return false;
        }
        var fileInput = document.getElementById('media');
        
        if (!fileInput.files || fileInput.files.length === 0) {
            document.getElementById("error_media").innerText =  'Please choose a file.';
            return false;
        }
        return true;
        // if (title.trim() === '') {
